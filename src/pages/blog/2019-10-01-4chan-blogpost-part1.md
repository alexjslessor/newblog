...
4chan has its own terminology and value system. For these reasons the natural language that exists in this very special place is one of a kind.
...
The endpoint we will be using is catalog: <https://a.4cdn.org/pol/catalog.json>
